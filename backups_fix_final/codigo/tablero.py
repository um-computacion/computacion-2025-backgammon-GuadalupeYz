...
class Tablero:
    ...
    def __init__(self) -> None:
        ...
        self.__points__: List[List[Ficha]] = [[] for _ in range(24)]
    ...
    def colocar_ficha(self, punto: int, ficha: Ficha) -> None:
        ...
        if len(self.__points__[punto]) >= 15:
