...
class TestCLIInicializacion(unittest.TestCase):
    ...
    def test_cli_inicia_sin_juego(self):
        ...
        self.assertFalse(cli._CLI__partida_activa__)

    def test_cli_estructura_basica(self):
        """Verifica que CLI tenga los atributos necesarios."""
        cli = CLI()
        self.assertTrue(hasattr(cli, '_CLI__juego__'))
        self.assertTrue(hasattr(cli, '_CLI__partida_activa__'))
...
class TestCLIIniciarPartida(unittest.TestCase):
    ...
    def test_iniciar_partida_crea_juego(self, _mock_print, _mock_input):
        ...
        self.assertIsNotNone(cli._CLI__juego__)
        self.assertIsInstance(cli._CLI__juego__, BackgammonGame)
        self.assertEqual(len(cli._CLI__juego__.get_jugadores()), 2)
...
class TestCLILoopPartida(unittest.TestCase):
    ...
    def test_movimiento_valido_se_ejecuta(self):
        ...
        cli = CLI()
        cli._CLI__juego__ = BackgammonGame()
        cli._CLI__partida_activa__ = True

        j1 = Jugador("Alice", "blanco")
        j2 = Jugador("Bob", "negro")
        cli._CLI__juego__.agregar_jugador(j1)
        cli._CLI__juego__.agregar_jugador(j2)
        cli._CLI__juego__.setup_inicial()

        # Simular dados disponibles
        cli._CLI__juego__._BackgammonGame__dados_disponibles__ = [3]

        # Ejecutar movimiento directamente
        cli._CLI__juego__.mover_ficha(j1, 23, 20)

        # Verificar que se registró en el historial
        historial = cli._CLI__juego__.get_historial()
...
class TestCLIMovimientos(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.cli = CLI()
        self.cli._CLI__juego__ = BackgammonGame()
        self.cli._CLI__partida_activa__ = True

        j1 = Jugador("Alice", "blanco")
        j2 = Jugador("Bob", "negro")
        self.cli._CLI__juego__.agregar_jugador(j1)
        self.cli._CLI__juego__.agregar_jugador(j2)
        self.cli._CLI__juego__.setup_inicial()
    ...
    def test_movimiento_normal_exitoso(self, _mock_print, _mock_input):
        ...
        self.cli._CLI__juego__._BackgammonGame__dados_disponibles__ = [3]

        jugador = self.cli._CLI__juego__.get_turno()

        try:
            # Simular un turno parcial
            origen = int(input("Origen: "))
            destino = int(input("Destino: "))
            self.cli._CLI__juego__.mover_ficha(jugador, origen, destino)
...
class TestCLIReingreso(unittest.TestCase):
    ...
    def test_detecta_fichas_en_bar(self):
        ...
        # Poner ficha en bar
        ficha = Ficha("blanco")
        self.cli._CLI__juego__.get_bar()["blanco"].append(ficha)

        barra = self.cli._CLI__juego__.get_bar()["blanco"]
...
class TestCLIBearOff(unittest.TestCase):
    ...
    def test_puede_sacar_fichas_cuando_todas_en_casa(self):
        ...
        # Limpiar tablero
        puntos = self.cli._CLI__juego__.get_tablero().get_points()
        for i in range(24):
            puntos[i].clear()

        j1 = self.cli._CLI__juego__.get_jugadores()[0]
        ...
        self.assertTrue(self.cli._CLI__juego__.puede_sacar_fichas(j1))
...
class TestCLIVictoria(unittest.TestCase):
    ...
    def test_detecta_ganador_cuando_jugador_sin_fichas(self):
        ...
        puntos = self.cli._CLI__juego__.get_tablero().get_points()
        j1, _j2 = self.cli._CLI__juego__.get_jugadores()
        ...
        ganador = self.cli._CLI__juego__.chequear_victoria()
...
class TestCLIHistorial(unittest.TestCase):
    ...
    def test_mostrar_historial_con_movimientos(self):
        ...
        cli._CLI__juego__.get_historial().append("Movimiento de prueba")
...
class TestCLIAbandonar(unittest.TestCase):
    ...
    def test_cancelar_abandonar_partida(self):
        ...
        self.assertTrue(cli._CLI__partida_activa__)
        self.assertIsNotNone(cli._CLI__juego__)
    ...
    def test_abandonar_sin_partida_activa(self, mock_print, _mock_input):
        """Test de abandonar sin partida activa."""
        cli = CLI()
        cli._CLI__partida_activa__ = False
...
class TestCLIMostrarHistorialTurno(unittest.TestCase):
    ...
    def test_mostrar_historial_turno_con_movimientos(self, mock_print):
        """Test de mostrar historial con movimientos."""
        self.cli._CLI__juego__.get_historial().append("Movimiento 1")
        self.cli._CLI__juego__.get_historial().append("Movimiento 2")
        self.cli._CLI__juego__.get_historial().append("Movimiento 3")
    ...
    def test_mostrar_historial_turno_limita_a_3(self, mock_print):
        ...
        for i in range(10):
            self.cli._CLI__juego__.get_historial().append(f"Mov {i}")
...
class TestCLIIntegracion(unittest.TestCase):
    ...
    def test_simular_victoria_completa(self):
        ...
        puntos = cli._CLI__juego__.get_tablero().get_points()
        for i in range(24):
            puntos[i].clear()
        ...
        j2._Jugador__fichas__ = [ficha_negra]

        ganador = cli._CLI__juego__.chequear_victoria()
        self.assertEqual(ganador, j1)
