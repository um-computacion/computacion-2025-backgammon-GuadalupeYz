...
class CLI:
    def __init__(self) -> None:
        self.__juego__: BackgammonGame | None = None
        self.__partida_activa__: bool = False
    ...
    def iniciar_partida(self) -> None:
        ...
        self.__juego__.agregar_jugador(jugador1)
        self.__juego__.agregar_jugador(jugador2)
        self.__juego__.iniciar_juego()
        self.__juego__.setup_inicial()
    ...
    def loop_partida(self) -> None:
        ...
        while self.__partida_activa__:
            juego = self.__juego__
            ...
            if opcion == "4":
                self.abandonar_partida()
                if not self.__partida_activa__:
                    break
                continue
    ...
    def mostrar_tablero(self) -> None:
        puntos = self.__juego__.get_tablero().get_points()
    ...
    def mostrar_historial_turno(self) -> None:
        historial = self.__juego__.get_historial()
        if historial:
            print("\nÚltimos movimientos:")
